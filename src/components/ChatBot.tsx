    ...
    const handleSendMessage = async (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            ...
            if (query.includes('shipping') || query.includes('delivery') || query.includes('track')) {
                ...
                botReply = "Here is the direct link to our best-selling deals section! <br/><br/><a href='/product-category/best-sellers' style='display:inline-block; padding:8px 12px; background:#fff; color:#2874f0; text-decoration:none; border-radius:4px; font-weight:bold; font-size:13px;'>SHOP UP TO 80% OFF SCENTS</a>";
                ...
                botReply = "Our current top best-sellers include Lattafa Khamrah, Afnan Turathi Electric, and Dumont Nitro Red. <br/><a href='/product-category/best-sellers' style='text-decoration:underline'>Click here to view our Best Sellers!</a>";
            } else if (query.includes('men') || query.includes('cologne') || query.includes('boy')) {
                botReply = "For men, we have an incredible selection including Creed, Dior Sauvage, and popular Arabian scents. <a href='/product-category/mens-fragrances' style='text-decoration:underline'>Browse Men's Collection here</a>.";
            } else if (query.includes('women') || query.includes('girl')) {
                botReply = "For women, our Floral and Gourmand collections are highly requested! Yara Pink by Lattafa and Burberry Her are excellent choices right now. <a href='/product-category/womens-fragrances' style='text-decoration:underline'>Browse Women's Collection here</a>.";
